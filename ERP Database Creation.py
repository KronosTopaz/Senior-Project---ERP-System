...
def main():
    ...
    inventoryData = [("Battery", 10038, 0.48, 5),
                     ...
                     ("Cable", 9573, 0.02, 15),
                     ("RAM", 1855, 1.27, 16),
                     ("Completed Phone", 1000, 1000, 22)]
    
    # Date, pID, totalCost
    orderData = [("2026-01-05", 14, 108.45),
                 ("2026-02-11", 8, 662.91),
                 ("2026-02-16", 9, 554.14),
                 ("2026-02-23", 13, 328.35),
                 ("2026-03-02", 16, 4785.36),
                 ]
    ...
    revenueData = [(1200.00, "2026-01-05", 18),
                   (2200.00, "2026-01-09", 19),
                   (3000.00, "2026-01-09", 21),
                   (6000.00, "2026-01-11", 20),
                   (5000.00, "2026-01-11", 21)]
